      ...
      {sorted.length === 0 ? (
        ...
        <div className="space-y-2.5">
          {sorted.slice(0, 12).map((e) => {
            ...
            return (
              <div key={e.id} className="flex items-center gap-3 p-3 border border-[#EFEFF2] rounded-xl bg-[#FAFAFB]">
                ...
                {e.submission_url && (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="text-[11px] font-semibold text-[#A78BFA] flex-shrink-0 underline"
                  >
                    View
                  </a>
                )}
